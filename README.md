...
Djot for users (and for you). A fork of [djot.js](https://github.com/jgm/djot.js) that attempts to make it safer to use by users. Features that can be exploited to execute code have been disabled.

## Changes to djot.js
* [x] HTML output omits raw_block and raw_inline
* [x] HTML output omits all attributes except
